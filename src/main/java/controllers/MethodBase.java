...
//    }
    ...
    public static void assertTrue_ByXpath(String locator,String Text) {
        SoftAssert softAssert = new SoftAssert();
        boolean hh= getDriver().findElement(By.xpath(locator)).isDisplayed();
        softAssert.assertTrue(hh,Text);
        softAssert.assertAll();
    }
    public static void assertTrue_ById(String locator,String Text) {
        SoftAssert softAssert = new SoftAssert();
        boolean hh= getDriver().findElement(By.id(locator)).isDisplayed();
        softAssert.assertTrue(hh,Text);
        softAssert.assertAll();
    }
